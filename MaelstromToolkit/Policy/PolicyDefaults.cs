...
internal static class PolicyDefaults
{
    internal const string DefaultPolicyText = """
# Default fallback policy (tooling)
[global]
schemaVersion = 1
...
prohibit = unauthorized_access, bypass_protections, tos_violations
